...
const SubscriptionPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4 sm:p-6 md:p-8">
            ...
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 w-full max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-4xl">
                ...
                <div className="flex-1 bg-white rounded-lg shadow-md p-5 sm:p-6 md:p-8 flex flex-col relative">
                    ...
                    <div className="text-center mb-4 sm:mb-6">
                        <div className="mt-2 flex items-center justify-center">
                            <span className="text-3xl sm:text-4xl md:text-5xl font-bold">9.99$</span>
                            <span className="text-gray-500 ml-1 text-sm sm:text-base">/month</span>
                        </div>
                    </div>
        ...
        ${isSubscribed ? "bg-gray-600 text-white cursor-not-allowed" : "bg-white border border-blue-500 text-blue-500 hover:bg-blue-50"}
    `}
                    >
                        {isSubscribed ? "Currently Active Plan" : loading ? (
                            <>
...
const Feature: React.FC<{ text: string }> = ({ text }) => (
    <div className="flex items-start">
        <svg className="h-5 w-5 flex-shrink-0 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
